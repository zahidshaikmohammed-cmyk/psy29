...
def main():
    ...
    # during the NSE session, fixture mode is NEVER permitted. This prevents
    # a test/fixture invocation from becoming a production data source.
    in_market=market_session()
    if in_market and a.mode=="fixture":
        raise SystemExit("PSY29 SAFETY BLOCK: fixture mode is forbidden during NSE market hours")
    ...
    if a.mode=="live":
        ...
        mode="live" if in_market else "fixture"

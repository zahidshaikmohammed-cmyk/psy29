...
def main():
    ...
    for symbol in symbols:
        try:
            ...
            latest_ts=int(x1.iloc[-1]["timestamp"]);age=(now_utc-datetime.fromtimestamp(latest_ts,tz=timezone.utc)).total_seconds()

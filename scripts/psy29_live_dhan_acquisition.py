...
IST=ZoneInfo("Asia/Kolkata");MASTER_URL="https://images.dhan.co/api-data/api-scrip-master-detailed.csv";FRESH_MAX_AGE_SECONDS=90;WARMUP_CALENDAR_DAYS=10;STRUCTURAL_SWING_BARS=20;SESSION_OPEN=dtime(9,15);SESSION_CLOSE=dtime(15,30);OPENING_RANGE_END=dtime(9,30)
